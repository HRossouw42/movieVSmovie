...
const onMovieSelect = async (movie, summaryElement, side) => {
  const response = await axios.get("http://www.omdbapi.com/", {
    params: { apikey: "32c267b5", i: movie.imdbID },
  });
...
//cleanup of element classes if earlier comparison was made
...
const runComparison = () => {
  ...
  leftSideStats.forEach((leftStat, index) => {
    ...
    const leftSideValue = parseInt(leftStat.dataset.value) || 0;
...
const movieTemplate = (movieDetail) => {
  // data values used for comparison
